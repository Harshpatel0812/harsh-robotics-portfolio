...
const projects = [
  {
    ...
    text: "A C++ BehaviorTree.CPP patrol system with Nav2, battery recovery, and OpenCV ArUco marker-triggered behavior transitions.",
  ...
  },
  {
    ...
    text: "D* Lite replanning and Artificial Potential Fields for goal-to-goal navigation through changing warehouse obstacles.",
  ...
  },
  {
    ...
    text: "Forward/inverse kinematics validation and repeatable joint, Cartesian, waypoint, and quintic trajectory execution.",
